...
public class ShopServiceManagerTest {
    ...
    public void before() {
        ...
        shopServiceManager = new ShopServiceManager(mongoDriver);
    }
    ...
    public void testAddProduct() {
        ...
        rx.Observable<String> res = shopServiceManager.addProduct(params);
    ...
    public void testAddUser() {
        ...
        rx.Observable<String> res = shopServiceManager.addUser(params);
